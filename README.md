...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uoz0lwa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uoz0lwa.containers.anotherwebservice.com/
...
```
git clone git@github.com:fabulou966/container-uoz0lwa.git
cd container-uoz0lwa
```
...
```
docker attach container-uoz0lwa
```
